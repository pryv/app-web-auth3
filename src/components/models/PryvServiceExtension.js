...
Pryv.Service.prototype.mfaChallenge = async function mfaChallenge(username: string, mfaToken: string, ): Promise<string> {
...
Pryv.Service.prototype.checkUsernameExistence = async function checkUsernameExistence
...
Pryv.Service.prototype.getUsernameForEmail = async function getUsernameForEmail
  (usernameOrEmail: string): Promise<string> {
...
Pryv.Service.prototype.requestPasswordReset = async function requestPasswordReset
  (username: string, appId: string): Promise<number> {
  const res = await Pryv.utils.superagent
